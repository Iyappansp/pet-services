...
(function () {
  ...
  const MOCK_DATA = {
    ...
    stats: [
      ...
      { label: 'Active Pets', value: 2, icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 14a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m0-12a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1-3-3M5 16a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m14 0a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3z"/></svg>', color: 'rgba(255,200,87,.15)', textColor: 'var(--secondary-dark)' },
    ...
    upcomingVisits: [
      { pet: 'Max', service: 'Dog Walking', sitter: 'Emma R.', date: 'Tomorrow', time: '9:00 AM', status: 'confirmed', petEmoji: '<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" style="color:var(--primary);"><path d="M12 14a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m0-12a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1-3-3M5 16a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m14 0a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3z"/></svg>' },
      { pet: 'Luna', service: 'Pet Sitting', sitter: 'Carlos M.', date: 'Jun 15', time: '2:00 PM', status: 'pending', petEmoji: '<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" style="color:var(--primary);"><path d="M12 14a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m0-12a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1-3-3M5 16a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m14 0a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3z"/></svg>' },
      { pet: 'Max', service: 'Dog Walking', sitter: 'Emma R.', date: 'Jun 17', time: '9:00 AM', status: 'confirmed', petEmoji: '<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" style="color:var(--primary);"><path d="M12 14a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m0-12a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1-3-3M5 16a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m14 0a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3z"/></svg>' }
    ],
    recentPhotos: [
    ...
    container.innerHTML = MOCK_DATA.walkHistory.map(w => `
      <div style="display:flex; align-items:center; gap:16px; padding:14px; background:var(--bg-2); border-radius:12px; margin-bottom:8px;">
        <div style="width:40px; height:40px; background:rgba(76,175,80,.1); border-radius:10px; display:flex; align-items:center; justify-content:center; color:var(--primary); flex-shrink:0;">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 14a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m0-12a3 3 0 0 1 3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1-3-3M5 16a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3m14 0a3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1-3 3z"/></svg>
        </div>
        <div style="flex:1; min-width:0;">
